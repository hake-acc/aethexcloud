...
export function PricingPage() {
  return (
    <>
       <section className="pt-32 pb-16 px-6"><div className="mx-auto max-w-[1280px]"><ScrollReveal><div className="flex flex-col items-center text-center gap-4"><SectionLabel>Pricing</SectionLabel><h1 className="text-5xl sm:text-6xl font-bold tracking-[-0.04em] text-white">Affordable VPS and server hosting pricing</h1><p className="max-w-2xl text-lg text-[#A1A1AA]">Compare cheap VPS hosting in India with Minecraft, Discord bot and Lavalink plans on AMD EPYC and NVMe infrastructure. No hidden fees.</p><p className="text-base text-[#71717A]">Not sure what fits? Browse our <a href="/services" className="text-white underline underline-offset-4 hover:text-white/70">hosting services</a> or read the <a href="/knowledge-base" className="text-white underline underline-offset-4 hover:text-white/70">Knowledge Base</a>.</p></div></ScrollReveal></div></section>
      <PricingSection />
       <section className="py-24 px-6"><div className="mx-auto max-w-[1280px]"><ScrollReveal><div className="aethex-surface aethex-border grid grid-cols-1 lg:grid-cols-2 gap-12 items-center rounded-[32px] border border-white/[0.08] p-10 lg:p-14"><div className="flex flex-col gap-5"><SectionLabel>Website Hosting</SectionLabel><h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-white">Affordable website hosting for portfolios and web apps</h2><p className="text-[#A1A1AA]">Deploy static sites, portfolios, blogs and full-stack web apps on reliable infrastructure. <a href="/contact" className="text-white underline underline-offset-4 hover:text-white/70">Contact us</a> to discuss the right plan for your project.</p><Button variant="primary" size="md" href="/contact" className="w-fit">Get in touch<IconArrowRight size={16} stroke={1.5} /></Button></div><div className="grid grid-cols-1 sm:grid-cols-2 gap-3">{websiteHostingFeatures.map((feature) => <div key={feature} className="flex items-center gap-3"><div className="flex-shrink-0 rounded-full border border-white/[0.08] bg-white/[0.04] p-0.5"><IconCheck size={12} stroke={2.5} className="text-white" /></div><span className="text-sm text-[#A1A1AA]">{feature}</span></div>)}</div></div></ScrollReveal></div></section>
